...
public class PublicFragment extends Fragment {
    ...
    private String id, money, date, purpose, url, people, date2, unit, money2, people2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPostReference.child("money").child(id).child("public").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    people=postSnapshot.child("people").getValue().toString()+" people";
                        ...
                        mPostReference.child("money").child(id).child("public").addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                                    ...
                                    people2=postSnapshot.child("people").getValue().toString();
                                    ...
                                    if (dateint>=planint && dateint<=plan2int){
                                        ...
                                        BigDecimal num=new BigDecimal(people2);
                                        BigDecimal result=big1.divide(big2, BigDecimal.ROUND_HALF_UP);
                                        txtresult+=result+"/"+people2+"\n+\n";
                                        result=result.divide(num, BigDecimal.ROUND_HALF_UP);
